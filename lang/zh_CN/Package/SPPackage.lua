...
return {
	...
	["olmumu2:discard"] = "弃置此防具",
	["olmumu2:obtain"] = "获得此防具",
	...
	["@ChenqingAsk"] = "%src 要挂了，您可以选择一名其他角色，对其发动“陈情”",
	["@ChenqingDiscard"] = "%src 对您发动了“陈情”，请您弃置四张牌。若您弃置的牌花色各不相同，视为其对濒死角色 %dest 使用一张【桃】",
	["moshi"] = "默识" ,
	[":moshi"] = "结束阶段开始时，你可以将一张手牌当你本回合出牌阶段使用的第一张基本或非延时类锦囊牌使用。然后，你可以将一张手牌当你本回合出牌阶段使用的第二张基本或非延时类锦囊牌使用。" ,
	["@moshi_ask"] = "默识：您可以将一张手牌当作【%arg】使用",
	["~moshi"] = "选择一张手牌->选择一些目标角色（如果需要）->点击“确定”",
